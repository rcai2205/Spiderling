...
import spiderling.lib.geometry.Rotation2d;
import spiderling.lib.geometry.Twist2d;
...
public class MecanumDriveOdometry {
     ...
     */
    public Pose2d updateWithTime(double period, Rotation2d gyroAngle,
                                 MecanumDriveSpeeds wheelSpeeds) {
     ...
     * @return The new pose of the robot.
     */
    public Pose2d update(double period, Rotation2d gyroAngle, MecanumDriveSpeeds wheelSpeeds) {
        return updateWithTime(period, gyroAngle, wheelSpeeds);
    }
}