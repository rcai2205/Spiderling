...
public class SwitchCheck extends Check
{
    ...
    public static class OptionCheck
    {
         ...
         * Note that another {@link Check Check} is a valid {@link GettableBoolean GettableBoolean}, but its {@link Check#initialise( spiderling.lib.actions.Action)}, {@link Check#onRun() onRun()} and {@link Check#onFinish() onFinish()} methods will not be called.
         *
