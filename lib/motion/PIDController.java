...
import spiderling.lib.math.MathUtil;
...
public class PIDController implements AutoCloseable {
     ...
     * @param secondsSinceLastCalculate The time since calculate was last called (seconds)
     */
    ...
    public double calculate(double measurement, double secondsSinceLastCalculate) {
        if(secondsSinceLastCalculate == 0) {
            System.out.println("Called calculate with a time delta of 0");
        }
        else {
